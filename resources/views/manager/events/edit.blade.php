                    ...
                    <form method="POST" action="{{ route('events.update',['event' => $event->id]) }}">
                        ...
                        <div class="md:flex justify-between items-end mt-4">
                            ...
                            <div class="flex space-x-4 justify-around">
                                <input type="radio" name="is_visible" @if ($event->is_visible) checked @endif value="1">表示
                                <input type="radio" name="is_visible" @if (!$event->is_visible) checked @endif value="0">非表示
                            </div>
